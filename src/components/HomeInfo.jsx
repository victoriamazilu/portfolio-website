...
const renderContent = {
  1: (
    <div>
      <h1 className="text-xl lg:text-2xl sm:leading-snug text-center neo-brutalism-blue py-1 px-8 lg:py-4 text-white mx-10 my-10">
        Hi, I'm <span className="font-semibold">Victoria!</span> 👋
        <br />
