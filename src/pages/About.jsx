    ...
    return (
        <section className="max-container">
            ...
            <div className="mt-5 flex flex-col cap-3 text-slate-500">
                <p>
                    Software Engineer from Toronto currently in my first year at
                    the University of Waterloo! My enthusiasm for learning and
                    innovating fuels my love for tackling challenging problems
            ...
            <div className="py-10 flex flex-col">
                ...
                <div className="py-20">
                    ...
                    <div className="mt-5 flex flex-col gap-3 text-slate-500">
                        <p>
                            I've worked with many types of companies, developing
                            both soft and technical skills. Here's a summary:
                        </p>
                    </div>
                </div>
